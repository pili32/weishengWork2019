        ...
        <Row>
          <Col span="24">
            <Row :gutter="20">
              ...
              <Col span="6">
                <FormItem label="机构名称" :label-width="75" style="width:100%">
          ...
          <Col span="24">
              <Row :gutter="20">
                ...
                <Col span="6">
                  <FormItem label="办公电话" :label-width="75" style="width:100%">
                    <Input v-model="queryPar.phone_number" placeholder="请输入办公电话" @on-enter="reload(true)"/>
                  </FormItem>
                </Col>
            </Row>
          </Col>
...
import {adminSearchYl , insOptionList} from "@/service/adminSearch";
export default {
  components: {
    Treeselect
  },
  ...
  methods: {
    reload(flag) {
      ...
      var where = {
        ...
        phone_number: this.queryPar.phone_number
      };
      let params = {
        page:{
        ...
        officePhone:this.queryPar.phone_number,
        realName:this.queryPar.real_name,
        userName:this.queryPar.user_name
      }
      adminSearchYl(params).then(res=>{
        this.loading = false;
        if(res.datas){
